...
const phases: Phase[] = [
  {
    ...
    steps: [
      ...
      { id: "0.12", title: "Build / homepage as full landing page (wire Hero + sections into app/page.tsx + layout)", status: "done" },
      { id: "0.12a", title: "Hero — split layout, Q logo, 'Ask once. Get the best price.' headline, CTAs, shadcn quote-comparison preview card", status: "done" },
      { id: "0.12b", title: "HowItWorks — 3-step 'ask → compete → compare' flow section", status: "done" },
      { id: "0.12c", title: "WhyDisquote — value-prop section", status: "done" },
      { id: "0.12d", title: "Categories — browse-by-category cards (shadcn Card + hover) ", status: "done" },
      { id: "0.12e", title: "StatsStrip — trust metrics strip", status: "done" },
      { id: "0.12f", title: "FinalCTA — closing call-to-action section", status: "done" },
      { id: "0.12g", title: "Migrate hero + category cards from raw divs to shadcn Card (container only, ring-0); add gentle hero-card float (CSS keyframes, reduced-motion guarded)", status: "done" },
      { id: "0.13", title: "Create app/about/page.tsx — company story placeholder", status: "done" },
      { id: "0.14", title: "Create app/contact/page.tsx — contact info + simple form (wired in Phase 4)", status: "done" },
      { id: "0.15", title: "Create app/terms/page.tsx — terms of service placeholder", status: "done" },
      { id: "0.16", title: "Create app/privacy/page.tsx — privacy policy placeholder", status: "done" },
      { id: "0.17", title: "Create app/auth/login/page.tsx — login placeholder (real auth in Phase 5)", status: "done" },
      { id: "0.18", title: "Create app/auth/register/page.tsx — register placeholder (real auth in Phase 5)", status: "done" },
  ...
  },
  {
    ...
    steps: [
      { id: "1.1", title: "Install @supabase/ssr (cookie-based auth client for Next 16)", status: "done" },
      ...
      { id: "1.6", title: "Generate TypeScript types from live Supabase schema (supabase gen types typescript)", status: "done" },
      { id: "1.7", title: "Save generated types to src/types/database.types.ts", status: "done" },
      { id: "1.8", title: "Create src/dal/product.dal.ts — getActiveProducts(), getProductBySlug(slug), serialize Decimal → string", status: "todo" },
      { id: "1.9", title: "Create src/dal/quote.dal.ts — createQuoteRequest(), getQuotesByUser(), getQuoteComparison(quoteId)", status: "todo" },
      { id: "1.10", title: "Smoke test: call getActiveProducts() from a server component, log count, deploy, verify live", status: "todo" },
    ],
  },
  {
    id: "phase-2",
