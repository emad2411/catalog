...
const phases: Phase[] = [
  {
    id: "phase-0",
    title: "Phase 0 — Foundation (site shell + all pages)",
    goal: "Clean up test files, design a logo, and add a real layout shell with header, footer, and every reserved route as a stub.",
    steps: [
      { id: "0.1", title: "Remove the temporary supabase-check.tsx test file", status: "done" },
      { id: "0.2", title: "Decide brand: logo (text mark vs icon + wordmark), company name, tagline", status: "todo" },
      { id: "0.3", title: "Create components/Logo.tsx (text-based, Voltagent-styled, no external image)", status: "todo" },
      { id: "0.4", title: "Add shadcn components we'll need: separator (have), input, label, textarea, sonner (toast), dropdown-menu", status: "todo" },
      { id: "0.5", title: "Create components/site/Header.tsx — Logo + nav (Products, About, Contact, Quotes, Sign in)", status: "todo" },
      { id: "0.6", title: "Create components/site/Footer.tsx — company info, link columns (Products, Company, Legal), contact, copyright", status: "todo" },
      { id: "0.7", title: "Create components/site/Container.tsx — max-width wrapper used by every page", status: "todo" },
      { id: "0.8", title: "Wire Header + Footer into app/layout.tsx so every page gets them automatically", status: "todo" },
      { id: "0.9", title: "Update / homepage to a real landing page (hero with Logo, tagline, CTA → /products, featured products grid)", status: "todo" },
      { id: "0.10", title: "Create app/about/page.tsx — company story placeholder (you replace copy later)", status: "todo" },
      { id: "0.11", title: "Create app/contact/page.tsx — contact info card + simple form (wired in Phase 5)", status: "todo" },
      { id: "0.12", title: "Create app/terms/page.tsx — terms of service placeholder (you replace copy later)", status: "todo" },
      { id: "0.13", title: "Create app/privacy/page.tsx — privacy policy placeholder (you replace copy later)", status: "todo" },
      { id: "0.14", title: "Create app/auth/login/page.tsx — login placeholder (real auth in Phase 6)", status: "todo" },
      { id: "0.15", title: "Create app/auth/register/page.tsx — register placeholder (real auth in Phase 6)", status: "todo" },
      { id: "0.16", title: "Create app/quotes/page.tsx — customer's quote requests placeholder (real auth in Phase 6)", status: "todo" },
      { id: "0.17", title: "Add app/not-found.tsx — global 404 page with link back to /", status: "todo" },
      { id: "0.18", title: "Verify live: every nav link in Header + Footer returns 200, no 404s, design is consistent across all pages", status: "todo" },
    ],
  },
  {
    id: "phase-1",
